...
export const QUESTIONS = [
  ...
  { selected: false, value: 'Q6', topic: 'Housing', label: 'Q6. (2018 only for testing) What is your current housing situation?' },
  { selected: false, value: 'Q6A', topic: 'Housing', label: 'Q6A. (2021 only for testing) Test question for 2021 only. (label from data.js)' },
  ...
  { selected: false, value: 'Q14_sp', topic: 'Transportation', label: 'Q14_sp. Which other transportation issues are most important to you?' },
  ...
  { selected: false, value: 'Q27_oth', topic: 'Economic opportunity and security', label: 'Q27_oth. What other barriers do you face getting a job or finding a better job?' },
