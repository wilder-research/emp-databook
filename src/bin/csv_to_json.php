...
$settings["source"] = './csv-2024.csv';

// where to save the output profiles - relative to script's directory
$settings["destination"] = '../docs/csv-2024.json';

// metadata about columns within the csv
$settings['num_columns'] = 31; //total number of columns in csv
...
//$settings["meta_columns"]['Qnum2021']      = 7; // 2021
...
$settings["meta_columns"]['DataColStart'] = 11; //index # for first data column (7 in 2018, 10 in 2021)
