...
$settings["source"] = './csv-2018.csv';

// where to save the output profiles - relative to script's directory
$settings["destination"] = '../docs/csv-2018.json';
...
$settings["meta_columns"]['DataColStart'] = 7; //index # for first data column (7 in 2018, 10 in 2021)
